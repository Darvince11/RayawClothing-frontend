...
import { ShoppingBag, Home, Menu, X, LogOut, User as UserIcon, ChevronDown } from 'lucide-react';
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#1E1E1E]/95 backdrop-blur-md border-b border-white/5">
      <div className="flex items-center justify-between py-4 px-6 max-w-7xl mx-auto w-full">
        ...
        {/* --- CENTERED MOBILE POPUP (FIXED) --- */}
        {isMobileOpen && (
          // Added 'z-[100]' so it sits ON TOP of the navbar
          // Added 'min-h-screen' to force true vertical centering
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 min-h-screen">
            
            {/* 1. Dark Backdrop (Dims the ENTIRE site) */}
            <div 
              className="absolute inset-0 bg-black/80 backdrop-blur-md"
              onClick={() => setIsMobileOpen(false)}
            ></div>

            {/* 2. The Menu Card (Now perfectly centered) */}
